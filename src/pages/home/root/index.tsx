...
function HomeRoot() {
  return (
    <div className="w-1440 h-[1098px] bg-white relative mx-auto">
      {/* Hero Section */}
      <div className="w-1440 h-[800px] relative bg-gradient-to-r from-white to-[#F6F6FF]">
        {/* Navigation Bar */}
        <nav className="absolute top-0 left-0 w-1440 h-[60px] bg-[rgba(250,250,252,0.8)] backdrop-blur-[8px] border-b border-[rgba(0,0,0,0.1)] flex items-center justify-between px-20 z-10">
          {/* Logo */}
          <div className="flex items-center gap-2 text-[#3E3E7B] text-2xl font-bold">
            <div className="w-10 h-10 bg-gradient-to-br from-grape-600 to-[#ED8EE9] rounded-full flex items-center justify-center text-white text-lg font-bold">
              A7
            </div>
        ...
        {/* Hero Content */}
        <div className="absolute left-20 top-[283px] w-[556px] flex flex-col gap-6">
          <h1 className="text-5xl font-semibold leading-[150%] bg-gradient-to-r from-grape-600 to-[#ED8EE9] bg-clip-text text-transparent m-0">
            <span className="font-['Inter'] font-bold">MIT 潘博士</span>
            <br />
            <span className="font-['PingFang_SC'] font-semibold">用AI逆转留学信息差</span>
          </h1>
          <p className="text-black text-xl font-normal m-0">让全世界年轻人都有更美好的未来！</p>

          {/* Button Group */}
          <div className="flex gap-5 mt-10">
            <button className="w-[200px] h-14 px-9 py-[15px] bg-grape-600 border border-[#23169B] rounded-xl text-white text-xl font-medium leading-[155%] cursor-pointer hover:bg-grape-700 hover:-translate-y-0.5 transition-all duration-300">
              学生/家长
            </button>
            <button className="w-[200px] h-14 px-9 py-[15px] bg-white border border-gray-300 rounded-xl text-black text-xl font-medium leading-[155%] cursor-pointer hover:bg-gray-50 hover:border-grape-600 transition-all duration-300">
              学校/机构
            </button>
          </div>
        </div>
        ...
        {/* Hero Image Section */}
        <div className="absolute right-0 top-[60px] w-[648px] h-[740px]">
          {/* Background Gradient */}
      ...
      {/* Footer */}
      <footer className="absolute bottom-0 w-1440 h-[298px] bg-[#F2F3F9] flex items-center justify-between px-[108px]">
        {/* Footer Logo */}
        <div className="flex items-center gap-3">
          <div className="w-[60px] h-[60px] bg-gradient-to-br from-grape-600 to-[#ED8EE9] rounded-full flex items-center justify-center text-white text-2xl font-bold">
            A7
          </div>
          <div className="font-['Inter'] text-[32px] font-bold text-[#3E3E7B]">Apply7</div>
        </div>

        {/* Social Section */}
        <div className="flex flex-col items-center gap-8">
          <h3 className="text-[#3E3E7C] text-xl font-semibold m-0">关注我们</h3>

          {/* Social Icons */}
          <div className="flex gap-6">
            {/* 小红书 */}
            <div className="flex flex-col items-center gap-2">
              <div className="w-[120px] h-[120px] bg-white rounded-xl flex items-center justify-center shadow-md">
                <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center text-gray-500 text-xs text-center leading-tight">
                  小红书
                  <br />
                  二维码
                </div>
            ...
            {/* MIT潘博士视频号 */}
            <div className="flex flex-col items-center gap-2">
              <div className="w-[120px] h-[120px] bg-white rounded-xl flex items-center justify-center p-3 shadow-md">
                <div className="w-24 h-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center text-gray-500 text-xs text-center leading-tight">
                  MIT潘博士
                  <br />
                  视频号
